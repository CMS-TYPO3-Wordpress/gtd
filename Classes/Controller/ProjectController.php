...
class ProjectController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    public function updateAction(\ThomasWoehlke\Gtd\Domain\Model\Project $project)
    {
        ...
        $msg = LocalizationUtility::translate('tx_gtd_flash.project.updated', $this->extName, null);
    ...
    public function deleteAction(\ThomasWoehlke\Gtd\Domain\Model\Project $project)
    {
        ...
        if($deleteable) {
            $msg = LocalizationUtility::translate('tx_gtd_flash.project.deleted', $this->extName, null);
        ...
        \ThomasWoehlke\Gtd\Domain\Model\Project $targetProject=null)
    {
        ...
        $msg = LocalizationUtility::translate('tx_gtd_flash.project.moved', $this->extName, null);
        $this->addFlashMessage(
    ...
    public function createTestDataAction()
    {
        ...
        $msg = LocalizationUtility::translate('tx_gtd_flash.testdata.created', $this->extName, null);
        $this->addFlashMessage($msg, '', \TYPO3\CMS\Core\Messaging\FlashMessage::OK);
