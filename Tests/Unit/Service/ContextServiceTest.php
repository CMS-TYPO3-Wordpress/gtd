...
class ContextServiceTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    ...
    protected function setUp()
    {
        ...
        $GLOBALS['TSFE']->fe_user->expects(self::any())->method('getKey')->with('ses', 'tx_gtd_fesessiondata')->will(self::returnValue(null));
    ...
    public function setCurrentContextTest(){
        ...
        $GLOBALS['TSFE']->fe_user->expects(self::once())->method('setKey')->with('ses', 'tx_gtd_fesessiondata',$sessionData);
